...
class DBTransforms:
    def __init__(self, transforms, keypoint_params, image_only_transforms=None):
        self.transform = A.Compose([
            *transforms,
            ToTensorV2()
        ], keypoint_params=keypoint_params)
        self.image_only_transform = A.Compose(image_only_transforms) if image_only_transforms else None
    ...
    def __call__(self, image, polygons):
        ...
        # keypoint 미지원 transform을 image에만 먼저 적용
